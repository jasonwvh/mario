(function() {
  ...
  var Ring = Mario.Ring = function(pos) {
    this.spawning = false;
    this.waiting = 0;

    Mario.Entity.call(this, {
      pos: pos,
      sprite: level.ringSprite,
      hitbox: [0,0,16,16]
    });
  }

  Mario.Util.inherits(Ring, Mario.Entity);

  Ring.prototype.render = function(ctx, vX, vY) {
  ...
  Ring.prototype.collideWall = function() {
    this.vel[0] = -this.vel[0];
  }

  Ring.prototype.checkCollisions = function() {
    if(this.spawning) {
      return;
    }
  ...
  Ring.prototype.isPlayerCollided = function() {
